...
DOCKERHUB_REPOSITORIES_FOR_LATEST = {
    ...
    'x-mysql': {
        ...
        'image': 'bitnami/mysql',
        'version': '8.0.32-debian-11-r22'
    },
    'x-mysql-deprecated': {
        'environment_variable': 'SENZING_DOCKER_IMAGE_VERSION_MYSQL',
        'image': 'bitnami/mysql',
        'version': '8.0.33-debian-11-r25'
    },
    'x-mysql-client': {
